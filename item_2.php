	...
	<body>
		...
		<nav class="menu">
			<menu class="menu__list">
				...
				<li class="menu__list-item" id="current"><a href="item_2.php" class="menu__list-link">Галерея постеров</a></li>
		...
		<div class="gallery__item" style="text-align: -webkit-center;">
			<?php while($row = $result->fetch_array(MYSQLI_ASSOC)) {
			?>
			<img src=<?php echo $row["linkOnImage"]?>>
			<?php }
			?>
		</div>
		<?php
